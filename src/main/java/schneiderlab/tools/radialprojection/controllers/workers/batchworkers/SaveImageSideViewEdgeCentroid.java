...
public class SaveImageSideViewEdgeCentroid extends SwingWorker<Void, Void> {
    BatchModeModel batchModeModel;

    public SaveImageSideViewEdgeCentroid(BatchModeModel batchModeModel) {
    ...
    protected Void doInBackground() throws Exception {
        for(ImageData<UnsignedShortType, UnsignedShortType> imageData : batchModeModel.getCentroidelectionList()){
            ...
            IJ.log("Saving SideView and Segmentation Complete: " + outputFileNameXylemWaterView);
        }
        return null;
    }
