...
//            String outputFileNameXylemWaterView = "Xylem_Water_View-"+filename;
        Path completeOutPutPath = imageData.getSideViewTempPathWithoutEdgeCentroid();
        IJ.log("temp image output path: " + completeOutPutPath);
        int noOfChannels = 4;
        ...
        copyImgPlusToChannel(hybrideStackSmoothed, merge, 3);
